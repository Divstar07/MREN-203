...
// -------------------------------------------- SERIAL COM ----------------------------------------------
  ...
  void seperateString(String string) {
    strSpeeds[0] += ((float)string[0] - 48);
    strSpeeds[0] += ((float)string[2] - 48) / 10;

    strSpeeds[1] += ((float)string[4] - 48);
    strSpeeds[1] += ((float)string[6] - 48) / 10; 
  }
...
// -------------------------------------------- LOOP ----------------------------------------------------
 void loop()
 {
    ...
    seperateString(str);
    V_desired = strSpeeds[0];
    Serial.print("V_desired = ");
    Serial.print(V_desired);
    omega_desired = strSpeeds[1];
